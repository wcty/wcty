...
import { File_Types_Enum, GetFilesDocument, GetFilesWithStatsDocument, PostFragment, PostInitiativeInfoFragment, useCreatePostMutation, useDeleteFilesMutation, useUpdatePostMutation } from "generated";
