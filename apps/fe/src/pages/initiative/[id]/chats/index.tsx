...
import { InitiativeBriefByPkDocument, InitiativeBriefByPkQuery, PostInitiativeInfoFragment, useChatsQuery, useMembersPageQuery } from 'generated'
...
export default function DynamicChat({ initiative }: { initiative: PostInitiativeInfoFragment }) {
  ...
  return <>
    ...
    <FixedBottom>
      <ContentWrapper>
        {chatList && <Chat {...{ chatList, initiative }} />}
      </ContentWrapper>
    </FixedBottom>
  </>
}
